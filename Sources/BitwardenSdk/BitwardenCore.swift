...
public struct FfiConverterTypeAuthRequestMethod: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AuthRequestMethod {
        ...
        case 1: return .userKey(
            protectedUserKey: try FfiConverterTypeAsymmetricEncString.read(from: &buf)
        )
        
        case 2: return .masterKey(
            protectedMasterKey: try FfiConverterTypeAsymmetricEncString.read(from: &buf), 
            authRequestKey: try FfiConverterTypeEncString.read(from: &buf)
        )
