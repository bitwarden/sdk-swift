...
public 
enum KeyGenerationError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
...
public 
enum SshKeyExportError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
...
public 
enum SshKeyImportError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
